...
def _load_env_into_os() -> None:
    ...
    for p in candidates:
        if p.exists():
            ...
            dotenv_values(p)  # nur um Datei zu validieren
            return
...
def load_config() -> Config:
    ...
    required = ["GCP_PROJECT", "GCP_LOCATION", "GEMINI_MODEL", "GOOGLE_APPLICATION_CREDENTIALS", "SYSTEM_PROMPT"]
    ...
    retrieval = RetrievalConfig()
    system_prompt = os.environ.get("SYSTEM_PROMPT", "Du bist ALESA, ein hilfreicher und freundlicher KI-Assistent.")
